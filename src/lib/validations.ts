...
export const updatePatientSchema = z.object({
  ...
  socioEconomic: z
    .object({
      housingStatus: z
        .enum(["Owned", "Rented", "With Family", "Shelter", "Other"])
        .optional(),
      houseType: z
        .enum(["House", "Apartment", "Room", "Katchi Abadi", "Other"])
        .optional(),
      ...
      waterSource: z
        .enum(["Tap", "Borewell", "Tank", "Community Tap", "Other"])
        .optional(),
      toiletType: z
        .enum(["Flush", "Pit Latrine", "Community", "None"])
        .optional(),
      cookingFuel: z
        .enum(["Gas", "Electric", "Kerosene", "Wood", "Coal", "Other"])
        .optional(),

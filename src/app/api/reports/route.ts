...
async function buildReport(start: Date, end: Date, period: string) {
  ...
  const assistanceByPatient = Object.values(patientAssistanceSummary).sort((a: any, b: any) => b.totalFoundation - a.totalFoundation);
...
export async function GET(request: Request) {
  try {
    ...
    const report = await buildReport(start, end, period);
